...
selected_sommets = []
 ...
 #creation de canvas dans le fenetre principale avec un couleur blanc both
...
menu_martices.add_command(label="Matrice adjacent")
menu_martices.add_command(label="Matrice incident")
menu_affichage.add_cascade(label="Matrice",menu=menu_martices)
menu_affichage.add_command(label="chain eulerienne")
menu_affichage.add_command(label="Chmeni")
